...
<main class="page-wrapper">
    <section class="page-inner">
        <header>
            <h1>PoE 2 Essence Calculator</h1>
        </header>
    ...
    <footer class="page-inner">
        <a href="#">Info for Nerds</a>
        |
        <a href="https://github.com/tomm1996/poe2-essence-calculator">Github</a>
        <p>
            <small><strong>Disclaimer by Developer:</strong> I'm by no means a mathematician and was kinda vibecoding the models with an LLM so don't sue me if you lose ingame currency when relying on these calculations thx</small>
        </p>
    </footer>
</main>
</body>
